...
public record ServiceOrderDetailDTO(Long id, OrderStatus orderStatus, Map<String, ServiceDetail> serviceDetail, ClientDetailDTO client, BigDecimal price, LocalDate date) {
}
